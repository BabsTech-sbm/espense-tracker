...
import { filterByDate } from "../services/Filter";
            ...
            <div className=" shadow-lg bg-gradient-to-r from-green-950 to-black flex flex-col gap-16 m-3 sm:m-5 p-5 rounded-2xl">
                ...
                <div className=" flex justify-between">
                    <div>
                        ...
                        <p className="text-xl font-bold text-red-400 mt-2">{formatAmount(currentMonth, "USD")}</p>
                    </div>
                    <div>
                        <h2 className="text-md font-semibold text-white">Upcoming Bills</h2>
                        <p className="text-xl font-bold text-orange-500 mt-2">N/A</p>
                    </div>
                </div>
            </div>
